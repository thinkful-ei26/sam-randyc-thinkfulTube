...
const render = function() {
  const html = store.videos.map(video => generateVideoItemHtml(video)).join('');
  $('.results').html(html);
};
...
//   const jSonString = $.getJSON(youTubeSearchUrl, query, proccessDataCallback);
 
// }
// $.getJSON('https://www.googleapis.com/youtube/v3/search?q=dog&key=AIzaSyAIf_3PceEbdUYn0ttqaPgw4F4akom9uDo&per_page=5', (proccessDataCallback) => {
//   console.log(proccessDataCallback);
// });
